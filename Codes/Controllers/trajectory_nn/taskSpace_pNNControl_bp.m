%% Masoud Pourghavam - Reza Bidari
%% Neural-net controller for trajectory tracking 
% @author: Masoud Pourghavam 
% @date: February, 2023
% @description:
...
% where the update law of neural net weight is defined as: (back propagation tuning)
...
savefig('results\back_propagation\trajnn_cartpos_error.fig')
...
savefig('results\back_propagation\trajnn_cartpos_path.fig');
...
savefig('results\back_propagation\trajnn_joint_torque.fig');
...
savefig('results\back_propagation\trajnn_cartpos_comp.fig');
